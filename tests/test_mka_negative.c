 ...
 */
static const uint8_t wrong_cak_32[32] =
{
    0x00u, 0x11u, 0x22u, 0x33u,
    0x44u, 0x55u, 0x66u, 0x77u,
    0x88u, 0x99u, 0xAAu, 0xBBu,
...
static const uint8_t wrong_cak_16[16] =
{
...
static int macsec_test_mka_negative_init(
    ...
    int verbose)
{
    ...
    {
        MACSEC_PRINT((
            "  MKA negative bad EtherType test, %u-byte CAK\n",
            (unsigned int)cak_len));
    }

    ret = macsec_test_mka_negative_init(&data->mka,
                                        cak,
                                        cak_len,
                                        test_mac_a,
                                        255u);
...
static int macsec_test_mka_negative_bad_eapol_type(
    macsec_test_mka_negative_bad_eapol_type_data_t *data,
    const uint8_t *cak,
    size_t cak_len,
    int verbose)
{
    ...
    {
        MACSEC_PRINT((
            "  MKA negative bad EAPOL type test, %u-byte CAK\n",
            (unsigned int)cak_len));
    }
...
static int macsec_test_mka_negative_short_frame(
    macsec_test_mka_negative_short_frame_data_t *data,
    const uint8_t *cak,
    size_t cak_len,
    int verbose)
{
    ...
    {
        MACSEC_PRINT((
            "  MKA negative short frame test, %u-byte CAK\n",
            (unsigned int)cak_len));
    }
...
static int macsec_test_mka_negative_bad_icv(
    macsec_test_mka_negative_bad_icv_data_t *data,
    const uint8_t *cak,
    size_t cak_len,
    int verbose)
{
    ...
    {
        MACSEC_PRINT((
            "  MKA negative bad ICV test, %u-byte CAK\n",
            (unsigned int)cak_len));
    }

    ret = macsec_test_mka_negative_init(&data->tx,
                                        cak,
                                        cak_len,
                                        test_mac_a,
                                        255u);
    ...
    ret = macsec_test_mka_negative_init(&data->rx,
                                        cak,
                                        cak_len,
                                        test_mac_b,
                                        100u);
...
static int macsec_test_mka_negative_reflected_own_frame_ignored(
    macsec_test_mka_negative_reflected_own_frame_ignored_data_t *data,
    const uint8_t *cak,
    size_t cak_len,
    int verbose)
{
    ...
    {
        MACSEC_PRINT((
            "  MKA negative reflected own frame ignored test, "
            "%u-byte CAK\n",
            (unsigned int)cak_len));
    }
...
static int macsec_test_mka_negative_wrong_cak_fails_icv(
    macsec_test_mka_negative_wrong_cak_fails_icv_data_t *data,
    const uint8_t *tx_cak,
    const uint8_t *rx_cak,
    size_t cak_len,
    int verbose)
{
    size_t frame_len = 0u;
    ...
    {
        MACSEC_PRINT((
            "  MKA negative wrong CAK fails ICV test, "
            "%u-byte CAK\n",
            (unsigned int)cak_len));
    }
                             ...
                             int verbose)
{
    ...
    TEST_OK(macsec_test_mka_negative_bad_ethertype(
        &data->test_mka_negative_bad_ethertype_data,
        test_cak_16,
        sizeof(test_cak_16),
        verbose));
    ...
    TEST_OK(macsec_test_mka_negative_bad_eapol_type(
        &data->test_mka_negative_bad_eapol_type_data,
        test_cak_16,
        sizeof(test_cak_16),
        verbose));
    ...
    TEST_OK(macsec_test_mka_negative_short_frame(
        &data->test_mka_negative_short_frame_data_data,
        test_cak_16,
        sizeof(test_cak_16),
        verbose));
    ...
    TEST_OK(macsec_test_mka_negative_bad_icv(
        &data->test_mka_negative_bad_icv_data_data,
        test_cak_16,
        sizeof(test_cak_16),
        verbose));
    ...
    TEST_OK(macsec_test_mka_negative_wrong_cak_fails_icv(
        &data->test_mka_negative_wrong_cak_fails_icv_data,
        test_cak_16,
        wrong_cak_16,
        sizeof(test_cak_16),
        verbose));
    ...
    TEST_OK(macsec_test_mka_negative_reflected_own_frame_ignored(
        &data->test_mka_negative_reflected_own_frame_ignored_data,
        test_cak_16,
        sizeof(test_cak_16),
        verbose));
