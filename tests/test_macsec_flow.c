...
static const uint8_t test_static_sak[16] =
{
...
static void macsec_test_static_config(macsec_config_t *cfg,
...
static int macsec_test_macsec_flow_static_bidirectional(macsec_test_macsec_flow_static_bidirectional_data_t *data, int verbose)
{
    ...
    macsec_test_fill_plain_frame(data->plain_a,
                                 plain_len,
                                 test_mac_b,
                                 test_mac_a,
                                 0x0800u,
