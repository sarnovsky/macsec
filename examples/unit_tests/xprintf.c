...
void xvprintf(struct xprintPar *par, const char *fmt, /* Pointer to the format string */
...
int xsnprintf(char *buff, int maxLen, const char *fmt, ...)
{
    va_list arp;
    struct xprintPar par;
